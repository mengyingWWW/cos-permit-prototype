...
export const MANUAL_PROCESSING_TIMES = [
  {
    category: 'Roofing & Envelope',
    permits: [
      { type: 'Reroofing Permit',             planReview: '30–60',  correction: '10–20', totalIssue: '45–85'  },
      { type: 'Window / Door Replacement',    planReview: '15–30',  correction: '7–14',  totalIssue: '25–50'  },
      { type: 'Siding Replacement',           planReview: '20–35',  correction: '7–14',  totalIssue: '30–55'  },
    ],
  },
  {
    category: 'Residential Construction',
    permits: [
      { type: 'Residential Addition',         planReview: '90–120', correction: '15–30', totalIssue: '115–165' },
      { type: 'Detached ADU',                 planReview: '100–140',correction: '20–35', totalIssue: '130–190' },
      { type: 'Deck / Porch',                 planReview: '30–45',  correction: '7–14',  totalIssue: '42–65'  },
      { type: 'Interior Remodel',             planReview: '45–65',  correction: '10–20', totalIssue: '60–92'  },
    ],
  },
  {
    category: 'Commercial & Multifamily',
    permits: [
      { type: 'Commercial Tenant Improvement',planReview: '60–90',  correction: '14–25', totalIssue: '82–130' },
      { type: 'Change of Use',                planReview: '60–85',  correction: '12–22', totalIssue: '78–120' },
      { type: 'Commercial Addition',          planReview: '120–150',correction: '20–35', totalIssue: '152–200' },
      { type: 'Multifamily Addition',         planReview: '130–160',correction: '25–40', totalIssue: '168–215' },
    ],
  },
  {
    category: 'New Construction',
    permits: [
      { type: 'New Single Family Residence',  planReview: '110–140',correction: '20–35', totalIssue: '142–190' },
      { type: 'New Multifamily Building',     planReview: '150–180',correction: '30–50', totalIssue: '195–250' },
    ],
  },
  {
    category: 'Site & Land',
    permits: [
      { type: 'Grading Permit',               planReview: '30–50',  correction: '7–14',  totalIssue: '42–70'  },
      { type: 'Accessibility Upgrade',        planReview: '25–45',  correction: '5–12',  totalIssue: '34–62'  },
    ],
  },
];

export const MANUAL_SELF_CHECK: { id: string; category: string; items: string[] }[] = [
  {
    id: 'applicant',
    category: 'Applicant Information',
    items: [
      'Applicant name matches the property owner of record',
      'Contact email and phone number are current and correct',
      'Date of birth and identification number entered accurately',
      'Mailing address is complete (street, city, state, ZIP)',
    ],
  },
  {
    id: 'contractor',
    ...
    items: [
      'Contractor name matches the licensed business name exactly',
      'Washington State contractor license number is valid',
      'Contractor license will remain valid through project completion and final inspection',
      'Financially responsible party information is complete',
    ],
  },
  {
    id: 'project',
    ...
    items: [
      'Project address is correct and matches parcel records',
      'Permit type selected matches the scope of work',
      'Zoning classification is correct for the project address',
      'Project description fully describes the scope, materials, and method',
      'Estimated construction cost is complete and accurate',
    ],
  },
  {
    id: 'documents',
    ...
    items: [
      'Building plans and elevations are attached and legible (min. 1/8" scale)',
      'Site plan shows property lines, setbacks, and structure location',
      'Energy compliance form references the current Seattle Energy Code edition',
      'All uploaded files are complete — no corrupted or truncated documents',
      'Electrical and plumbing plans attached if work involves those systems',
    ],
  },
  {
    id: 'compliance',
    ...
    items: [
      'Proposed work complies with Seattle zoning and land use code (SMC Title 23)',
      'Fire rating and material specifications meet IBC requirements as adopted by SMC 22.100',
      'If project value exceeds $150,000 in MR/NC zones, Design Review notification may be required',
      'Applicable energy code version confirmed with SDCI before submission',
    ],
  },
];

// ── End manual-mode data ──────────────────────────────────────────────────────
